<template>
    <AppLayout title="Patients">
        <template #header>
            <div class="flex">
                <h2 class="flex-1 font-semibold text-xl text-gray-200 leading-tight">patient Details</h2>
                <Link :href="'/patients/email/' + patient.id" class="bg-green-500 text-white font-semibold py-2 px-4 border border-gray-700 rounded mb-2 mr-2">Send Email</Link>
                ...
                <div class="bg-green-100 overflow-hidden shadow-lg sm:rounded-lg">
                    <div class="p-6 text-gray-900 flex">
                        ...
                        <div class="flex-1 ml-4">
                            <div class="flex">
                                <div>
                                    <Link class="bg-green-500 text-white font-semibold py-2 px-4 border border-gray-700 rounded mb-2 mr-2" :href="'/patients/' + patient.id" method="delete" as="button">Delete</Link>
                                    <Link class="bg-green-500 text-white font-semibold py-2 px-4 border border-gray-700 rounded mb-2" :href="'/patients/edit/' + patient.id" as="button">Edit</Link>
                                </div>
                            </div>
